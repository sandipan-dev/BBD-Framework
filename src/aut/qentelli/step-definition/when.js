...
When(/^I click on the Thought LeaderShip tab$/, async () =>{
    await testPage.clickOnThoughtLeadershipTab();
});
When(/^I click on Case Studies link$/, async ()=>{
    await testPage.clickOnCasestudiesLink();
});
